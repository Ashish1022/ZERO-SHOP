...
import { StickerPeelAnimation } from "./sticker-peel";
      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold leading-[0.9] tracking-tighter mb-6">
              Your Art.
              <br />
              <span className="text-muted-foreground">Our Sticky-ness.</span>
            </h1>

            <p className="text-lg md:text-xl text-white/60 max-w-xl mb-10">
              Upload your designs and we'll turn them into premium die-cut
              stickers. Perfect for artists, creators, and anyone who wants to
              stick their mark.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                ...
                onClick={() => {
                  document
                    .getElementById("community-gallery")
